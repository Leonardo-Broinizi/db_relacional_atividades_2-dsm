...
'Em Monitoramento',
(SELECT id_tipo_evento FROM tipo_evento WHERE nome = 'Queimada'),
(SELECT id_localizacao FROM localizacao WHERE cidade = 'Rio de Janeiro' AND sigla_estado = 'RJ')
);

INSERT INTO tipo_evento(nome, descricao) VALUES ('Enchente', 'Alagamentos por chuvas intensas ou transbordo');

UPDATE evento SET id_tipo_evento = 4 WHERE id_evento = 8 ;
